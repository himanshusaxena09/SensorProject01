...
class ModelTrainer:
    def __init__(self):
        ...
        self.model = {'XGBClassifier':XGBClassifier(), 'GradientBoostingClassifier':GradientBoostingClassifier(),'svc':SVC(), 'RandomForestClassifier':RandomForestClassifier()}
    ...
    def evaluate_models(self,x,y,models):
        try:
            ...
            for i in range(len(list(models))):
                ...
                train_model_score = accuracy_score(x_train,y_train_predict)
                test_model_score = accuracy_score(x_test,y_test_predict)
    ...
    def get_best_model(self,x_train:np.array,y_train: np.array,x_test:np.array,
                    y_test: np.array):
        try:
            model_report: dict = self.evaluate_models(x_train =  x_train,
                 y_train = y_train,x_test =  x_test,y_test = y_test,models = self.models)
    ...
    def finetune_best_model(self,best_model_object:object,best_model_name,X_train,
                            y_train,) -> object:
    ...
    def initiate_model_trainer(self, train_array, test_array):
        try:
            ...
            best_model = self.finetune_best_model(best_model_name= best_model_name,
                best_model_object= best_model,X_train= x_train,y_train= y_train)
