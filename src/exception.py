...
#     error_message = "Error occured python script name [{0}] line number[{1}] error message[{2}]".format(file_name,exc_tab.tab_lineno.str(error))
...
#         self.error_mesaage = error_message_detail(
